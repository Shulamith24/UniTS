...
class Model(nn.Module):
    ...
    """masking"""
    #对每个样本的时序随机遮蔽一定比例的时间步，遮蔽位置在序列中随机分布
    ...
    def get_mask_seq(self, mask, seq_len):
        ...
        return mask_seq
    """x:[batch_size,seq_len,n_vars], prefix_prompt:[1,n_vars,prompt_num,d_model]
        mask_token:[1,n_vars,1,d_model], cls_token:[1,n_vars,1,d_model]"""
